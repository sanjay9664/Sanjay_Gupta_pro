...
export default function AboutPage() {
  return (
    <div className="pt-28 sm:pt-36 pb-16 sm:pb-24 px-3 sm:px-6 lg:px-8 max-w-5xl mx-auto flex flex-col gap-10 sm:gap-14 relative z-10">
      <JsonLd
        type="Organization"
        data={{
      ...
      <div className="p-5 sm:p-8 rounded-3xl bg-white border border-slate-200/80 flex flex-col gap-6 sm:gap-8 shadow-xl shadow-slate-200/40">
        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 font-heading">Full-Stack Tech Stack Architecture</h2>
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-3.5 sm:gap-4">
          <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-200 flex flex-col gap-2">
