      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col gap-5">
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200/80 shadow-lg shadow-slate-200/40 flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-xs text-slate-500 font-mono font-bold uppercase">Direct Phone / Call</span>
              <a href={`tel:${SITE_CONFIG.contact.phone.replace(/[^0-9+]/g, '')}`} className="text-sm font-bold text-slate-900 hover:text-emerald-600 transition-colors">
