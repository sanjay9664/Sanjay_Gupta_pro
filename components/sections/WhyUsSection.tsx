        ...
        {WHY_ITEMS.map((item, idx) => {
          ...
          return (
            <motion.div
              ...
              className="p-6 rounded-3xl bg-white border border-slate-200/80 shadow-lg shadow-slate-200/30 hover:border-indigo-300 hover:shadow-xl transition-all flex flex-col gap-3 group"
            >
